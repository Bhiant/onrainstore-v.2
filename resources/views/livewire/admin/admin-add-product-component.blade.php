        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-info">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="addProduct" onsubmit="$('#processing').show();">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div  class="col-sm-10">
                          <input type="text" class="form-control" id="link" placeholder="Link" wire:model="short_description"/>
                    ...
                    <div class="form-group row">
                        ...
                        <div  class="col-sm-10">
                          <input type="file" class="input-file" id="gbrproduk" wire:model="image"/>
                          @if($image)
                    ...
                    <div class="form-group row">
                        ...
                        <div  class="col-sm-10">
                          <input type="file" class="input-file" id="gbrproduk" wire:model="images" multiple/>
                          @if($images)
